...
function seedInitialDataIfEmpty() {
  ...
  if (itemsSheet.getLastRow() < 2) {
    var items = [
      ...
      ['لحم', 'لحم الشيف 1', '1/3', true, 1],
      ['لحم', 'لحم الشيف 2', '1/3', true, 2],
      ['لحم', 'لحم الشيف 3', '1/3', true, 3],
      ['بحري', 'سالمون', '1/3', false, 1],
      ['بحري', 'سمك الشيف (جمبو)', '1/3', false, 2],
      ['بحري', 'جمبري بروفنسال', '1/3', false, 3],
